  ...
  <main id="main">
    ...
    <section id="services">
      <div class="container wow fadeIn">
        <div class="section-header">
          <h3 class="section-title">Profil Desa</h3>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="box">
              ...
              ?>
              <h4 class="title"><a href=""><?php echo $data[1]?></a></h4>
              <?php echo "<img src='assets/img/dummies/$data[4]' weight=150 height=150>";?>
              <p class="description"><?php echo $data[2]?></p>
            </div>
          </div>
    ...
    <section id="portfolio">
      <div class="container wow fadeInUp">
        <div class="section-header">
          <h3 class="section-title">Potret Desa</h3>
          <p class="section-description">Desa Wisata Bahari Bungi Permai</p>
        </div>
        <div class="row">
